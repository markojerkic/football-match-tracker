...
export const getGamesForManager = async (managerId: string): Promise<GameForPlayerOrManagerInSeason[]> => {
...
export const getGamesForPlayer = async (playerId: string): Promise<GameForPlayerOrManagerInSeason[]> => {
